...
import com.blog.ken.myblog.widget.StickyScrollView;
import com.jaeger.library.StatusBarUtil;

public class StickyScrollViewActivity extends AppCompatActivity implements View.OnClickListener, StickyScrollView.OnScrollChangedListener {
    ...
    private void initView() {
        ...
        StatusBarUtil.setTranslucentForImageView(StickyScrollViewActivity.this, 0, title);
    ...
    public void onScrollChanged(int l, int t, int oldl, int oldt) {
        if (t <= 0) {
            ...
            StatusBarUtil.setTranslucentForImageView(StickyScrollViewActivity.this, alpha, title);//设置状态栏的透明度
        } else {
            llTitle.setBackgroundColor(Color.argb((int) 255, 227, 29, 26));
            StatusBarUtil.setTranslucentForImageView(StickyScrollViewActivity.this, 255, title);
        }
    }
}
